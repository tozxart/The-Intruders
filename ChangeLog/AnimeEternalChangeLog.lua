return {
  ...
  News = {
    ...
    "> Introduced new raids and an additional dungeon",
    "> Optimized FPS and reduced GPU usage",
    "> Improved anti-lag system for smoother performance",
    "> Fixed rare bugs and stability issues",
    "> Corrected dungeon notifications — when available, it won't auto-farm",
    "> Improved auto status functionality",
    "> Added auto join/auto farm for both dungeons and raids",
    "> Added an option to choose which maps to farm",
    "V 1.19 - 9/29/2025",
